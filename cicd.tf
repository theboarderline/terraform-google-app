...
resource "google_cloudbuild_trigger" "cloudbuild_trigger" {
  ...
  build {
    ...
    step {
      ...
      entrypoint = "bash"
      args = [
        "-c", "gcloud container clusters get-credentials ${var.cluster_name} --zone=${var.zone} --project=${var.gke_project_id}",
      ]
    }
